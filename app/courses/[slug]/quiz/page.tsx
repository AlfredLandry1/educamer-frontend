...
export default function QuizPage() {
  ...
  const calculateScore = () => {
    ...
    // Bonus streak
    if (correctAnswers >= 3) {
      bonusXP += currentStreak * 10;
      bonusCoins += currentStreak * 5;
    }
          ...
          {showPerfectAnimation && (
            <div className="fixed inset-0 bg-yellow-400 bg-opacity-20 flex items-center justify-center z-50 animate-pulse">
              <div className="text-center">
                <Crown size={80} className="text-yellow-500 mx-auto mb-4" />
  ...
  return (
    <DashboardLayout>
      <div className="w-full animate-fade-in flex flex-col gap-8">
        ...
        {/* Animation streak */}
        {showStreakAnimation && (
          <div className="fixed top-4 right-4 bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 animate-bounce">
            <div className="flex items-center gap-2">
              <Flame size={20} />
